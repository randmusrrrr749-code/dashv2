      ...
      <div className="space-y-4">
        <div>
          ...
          <select
            ...
            className="w-full rounded-xl bg-black/30 border border-white/10 px-3 py-2 text-sm text-gray-100"
          >
        ...
        <div className="rounded-xl border border-white/10 bg-black/30 p-3">
          <p className="text-xs text-gray-400">Saved preferences</p>
          <p className="text-sm text-gray-200 mt-1">
            Currency: <span className="text-lime-300 font-semibold">{currency}</span> ·
            Numbers: <span className="text-lime-300 font-semibold">{numbers}</span>
          </p>
        </div>
      </div>
    </div>
